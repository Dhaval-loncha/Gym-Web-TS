			...
			<motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Benefits)}>
				...
				<div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
					...
					<div>
						...
						>
							<p className="my-5">
								Nascetur aenean massa auctor tincidunt. Iaculis potenti amet egestas ultrices consectetur
								adipiscing ultricies enim. Pulvinar fames vitae vitae quis. Quis amet vulputate tincidunt at
								in nulla nec. Consequat sed facilisis dui sit egestas ultrices tellus. Ullamcorper arcu id
